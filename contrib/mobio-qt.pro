...
RESOURCES += src/qt/mobio.qrc src/qt/mobio_locale.qrc

TRANSLATIONS += src/qt/locale/mobio_bg.ts \
                src/qt/locale/mobio_de.ts \
                src/qt/locale/mobio_en.ts \
                src/qt/locale/mobio_es.ts \
                src/qt/locale/mobio_fi.ts \
                src/qt/locale/mobio_fr.ts \
                src/qt/locale/mobio_it.ts \
                src/qt/locale/mobio_ja.ts \
                src/qt/locale/mobio_pl.ts \
                src/qt/locale/mobio_pt.ts \
                src/qt/locale/mobio_ru.ts \
                src/qt/locale/mobio_sk.ts \
                src/qt/locale/mobio_sv.ts \
                src/qt/locale/mobio_vi.ts \
                src/qt/locale/mobio_zh_CN.ts \
                src/qt/locale/mobio_zh_TW.ts
