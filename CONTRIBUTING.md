Contributing to Mobio Core
============================

The Mobio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mobio Core project, and is not to be
confused with overall Mobio Network Protocol consensus changes.

Whether a pull request is merged into Mobio Core rests with the project merge
...
Patches that change Mobio consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mobio consensus, it must have been
...
The project leader is the release manager for each Mobio Core release.
