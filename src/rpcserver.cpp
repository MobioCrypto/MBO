...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mobio features */
        {"mobio", "masternode", &masternode, true, true, false},
        {"mobio", "listmasternodes", &listmasternodes, true, true, false},
        {"mobio", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mobio", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mobio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mobio", "masternodedebug", &masternodedebug, true, true, false},
        {"mobio", "startmasternode", &startmasternode, true, true, false},
        {"mobio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mobio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mobio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mobio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mobio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mobio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mobio", "mnbudget", &mnbudget, true, true, false},
        {"mobio", "preparebudget", &preparebudget, true, true, false},
        {"mobio", "submitbudget", &submitbudget, true, true, false},
        {"mobio", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mobio", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mobio", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mobio", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mobio", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mobio", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mobio", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mobio", "checkbudgets", &checkbudgets, true, true, false},
        {"mobio", "mnsync", &mnsync, true, true, false},
        {"mobio", "spork", &spork, true, true, false},
        {"mobio", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mobio", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mobiod, or the -server option to mobio-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mobio-cli " + methodname + " " + args + "\n";
}
