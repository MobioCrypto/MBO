                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Mobio from zMobio"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMobio"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMobio));
