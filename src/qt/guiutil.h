...
/** Utility functions used by the Mobio Qt UI.
 */
namespace GUIUtil
{
...
// Render Mobio addresses in monospace font
...
// Parse "mobio:" URI into recipient object, return true on successful parsing
