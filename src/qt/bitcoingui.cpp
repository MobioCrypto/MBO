                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mobio Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mobio address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mobio: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mobio Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mobio Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mobio"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mobio addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mobio addresses"));
    ...
    openAction->setStatusTip(tr("Open a Mobio: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mobio Core help message to get a list with possible Mobio command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mobio Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mobio network", "", count));
}
...
{
    QString strTitle = tr("Mobio Core"); // default title
...
/** Creates context menu, its actions, and mobios up all the relevant signals for mouse events. */
