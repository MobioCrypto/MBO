...
In order to support loading of multiple wallets in mobio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mobio.cpp.
...
Changes to mobio.cpp
----------------------
mobio.cpp is the entry point into mobio-qt, and as such, will require some minor modifications to provide hooks for
